...
<err:ErrorResponse xmlns:err="http://www.govtalk.gov.uk/CM/errorresponse" xmlns:dsl="http://decisionsoft.com/rim/errorExtension" SchemaVersion="2.0">
  <err:Error>
    ...
    <err:Number>8657</err:Number>
    <err:Type>business</err:Type>
    <err:Text>The 'Street and Number' field of (Representative) Trader must not be present if the 'TIN' has been declared (C501)</err:Text>
    <err:Location>/ie:CC315A[1]/TRAREP[1]/StrAndNumTRE1[1]</err:Location>
  </err:Error>
</err:ErrorResponse>
