...
<err:ErrorResponse xmlns:err="http://www.govtalk.gov.uk/CM/errorresponse"
    ...
    <err:Error>
        ...
        <err:Number>8700</err:Number>
        <err:Type>business</err:Type>
        <err:Text>The field 'Language' within Import Operation.Trader Consignor must not be present if the GB 'TIN' has been declared (C501)</err:Text>
