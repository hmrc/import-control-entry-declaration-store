...
<err:ErrorResponse xmlns:err="http://www.govtalk.gov.uk/CM/errorresponse" xmlns:dsl="http://decisionsoft.com/rim/errorExtension" SchemaVersion="2.0">
  <err:Error>
    ...
    <err:Number>8678</err:Number>
    <err:Type>business</err:Type>
    <err:Text>The field 'Item Number' within 'Goods Item' must not contain leading zeros</err:Text>
    <err:Location>/ie:CC315A[1]/GOOITEGDS[1]/IteNumGDS7[1]</err:Location>
  </err:Error>
  <err:Error>
    <err:RaisedBy>ChRIS</err:RaisedBy>
